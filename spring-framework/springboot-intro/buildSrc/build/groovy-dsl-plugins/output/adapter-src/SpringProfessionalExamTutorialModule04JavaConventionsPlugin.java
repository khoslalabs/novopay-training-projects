...
/**
 * Precompiled spring-professional-exam-tutorial-module04.java-conventions script plugin.
 **/
public class SpringProfessionalExamTutorialModule04JavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_SpringProfessionalExamTutorialModule04JavaConventions").asSubclass(BasicScript.class);
