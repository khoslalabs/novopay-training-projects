...
/**
 * Precompiled spring-professional-exam-tutorial-module07.java-conventions script plugin.
 **/
public class SpringProfessionalExamTutorialModule07JavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_SpringProfessionalExamTutorialModule07JavaConventions").asSubclass(BasicScript.class);
