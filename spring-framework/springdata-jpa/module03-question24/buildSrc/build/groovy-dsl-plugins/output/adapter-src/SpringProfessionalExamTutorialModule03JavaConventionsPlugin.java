...
/**
 * Precompiled spring-professional-exam-tutorial-module03.java-conventions script plugin.
 **/
public class SpringProfessionalExamTutorialModule03JavaConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_SpringProfessionalExamTutorialModule03JavaConventions").asSubclass(BasicScript.class);
