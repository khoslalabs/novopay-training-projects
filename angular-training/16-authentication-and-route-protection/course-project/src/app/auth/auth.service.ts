...
export class AuthService {
	...
	signup(email: string, password: string) {
        ...
        'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBvFZ6pa68C3d06iN8fLyP9ca8jXYjtlr0', 
        {
          email: email,
          password: password,
	...
	login(email: string, password: string) {
		return this.http
			.post<AuthResponseData>(
        'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBvFZ6pa68C3d06iN8fLyP9ca8jXYjtlr0',
				{
					email: email,
					password: password,
					returnSecureToken: true
